    ...
    <div class="wrapper">
      ...
      <div class="add-table" style="margin-top: 5px;padding: 20px 10px 0;">
        <el-table style="width: 100%;" class="anone">
          <el-table-column prop="ato" label="SKU Type" width="200"></el-table-column>
          <el-table-column prop="imdc" label="Item" width="200"></el-table-column>
          <el-table-column prop="type" label="Desciption"></el-table-column>
          <el-table-column prop="sku" label="Quantity" width="220"></el-table-column>
        </el-table>
      ...
      <div class="footer" style="background-color: #fff;border-top: 2px solid #41923e;height: 47px;">
        <div class="fl ac" style="padding-top: 3px;">
          <el-popover placement="top-start" width="320" :ref="`popover-1`" trigger="click" class="">
            <div style="background-color: #f5f5f5;padding: 10px 15px;color: #41923e;font-size:1.12em">
                <span style="font-weight: bold;">金额：</span>
                <i @click="handleCloseReview()" class="el-icon-close" style="float: right;cursor: pointer;color: #333;fonbt-size:1.62em"></i>
            </div>
            <el-table :data="newData" class="table-th-none">
              <el-table-column width="200" property="ato" label="">
                    <template slot-scope="scope">
                        [<strong style="font-weight: bolder;font-size:1.2em">{{scope.row.type}}</strong>]<br>{{scope.row.title}}
                    </template>
              </el-table-column>
              <el-table-column>
                  <template slot-scope="scope">
                    <el-input-number readonly style="width: 7em;" v-model="scope.row.num" @change="((val,oldValue)=>{handleChange(val,oldValue, scope.row)})"
                      size="mini" :min="1"></el-input-number>
                  </template>
              </el-table-column>
            </el-table>
            <span slot="reference" style="position: relative;display: inline-block;cursor: pointer;">
              <img src="../../assets/img/add1-total.png" alt="">
              <span v-if="10" style="position: absolute;top: 3px;left: 33px;font-style: normal;background-color: #c11111;border-radius: 50%;width: 1.52em;height: 1.52em;line-height: 1;text-align: center;color:#fff;border:3px solid #ededed">
                <i style="font-size: .75em;font-style: normal;">1</i>
              </span>
